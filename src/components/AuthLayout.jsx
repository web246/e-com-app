...
export default function AuthLayout({ title, subtitle, children, footer }) {
  return (
    <div className="min-h-screen bg-white flex flex-col px-6 pt-10 pb-10 relative overflow-hidden">
      <div className="absolute -top-24 -right-20 w-56 h-56 rounded-full bg-slate-100" />
      <div className="absolute top-48 -left-28 w-52 h-52 rounded-full bg-slate-50" />
      <motion.div
      ...
      >
        <div className="flex flex-col items-center mb-6">
          <div className="w-20 h-20 rounded-3xl bg-white shadow-md ring-1 ring-slate-200 p-2.5 mb-3">
            <img src={logo} alt="Dennis Mendez" className="w-full h-full object-contain" />
          </div>
          <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-slate-600">Dennis Mendez</p>
        </div>
